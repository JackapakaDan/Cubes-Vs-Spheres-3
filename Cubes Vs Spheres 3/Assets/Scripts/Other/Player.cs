...
public class Player : MonoBehaviour
{
    ...
    void Start()
    {
        Globals.attackKey = attackKey;
        Globals.jumpKey = jumpKey;
        Globals.forwardKey = forwardKey;
        Globals.backwardKey = backwardKey;
        Globals.leftKey = leftKey;
        Globals.rightKey = rightKey;
        Globals.changeHandKey = changeHandKey;
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyUp(Globals.changeHandKey))
        {
        ...
        void FixedUpdate()
    {
        ...
        if (Input.GetKey(Globals.leftKey))
        {
        ...
        if (Input.GetKey(Globals.rightKey))
        {
            rb.AddForce(transform.right * speed);
            if (!Globals.curWeapon.ContainsValue(Globals.Weapon.Chompers))
            {
        ...
        if (Input.GetKey(Globals.jumpKey))
        {
            rb.AddForce(transform.up * speed);
        }
        if (Input.GetKey(Globals.forwardKey))
        {
        ...
        if (Input.GetKey(Globals.backwardKey))
        {
            rb.AddForce(-transform.forward * speed);
            if (!Globals.curWeapon.ContainsValue(Globals.Weapon.Chompers))
            {
